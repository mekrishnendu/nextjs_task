  ...
  return (
    <main>
      <div className="outer grid">
            ...
            <nav className="text-right">
              <ul className="text-gray-700 flex">
                <li>
                  <a
                    href="#"
                    className="flex justify-end mr-4 text-[#050DC9] border-b-2 border-[#050DC9]"
                  >
                    <span>Home</span>
                    <svg
                      class="w-5 ml-1"
                ...
                <li>
                  <a
                    href="#"
                    className="flex justify-end mr-4 hover:text-[#050DC9] border-b-2 border-white"
                  >
                    <span>About</span>
        ...
        <div className="content-area bg-[#2B2929] text-stone-100 py-20 px-40">
        ...
        <div className="footer text-center">
          <p className="text-sm p-2">Copy right</p>
        </div>
      </div>
    </main>
  );
